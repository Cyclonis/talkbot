...
4. Copy config\auth.example.json and rename it as config\auth.jso. Add in the appropriate tokens, turn off or on tts services. If your just using google TTS Turn off amazon and azure
